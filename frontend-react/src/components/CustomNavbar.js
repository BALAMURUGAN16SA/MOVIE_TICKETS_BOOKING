...
import { FiMenu, FiUser, FiHome, FiFilm, FiVideo, FiRotateCcw } from 'react-icons/fi';
import { HiOutlineTicket } from 'react-icons/hi2';
import { debounce } from 'lodash'; // Make sure to install lodash or use your own debounce
import { useNavigate } from 'react-router-dom';
import './CustomNavbar.css';

const CustomNavbar = ({ setShowProfile, loginOutButton, setLoginOutButton, setShowLogin, onMoviesClick, onTheatersClick, setShowHistory, setShowContact}) => {
