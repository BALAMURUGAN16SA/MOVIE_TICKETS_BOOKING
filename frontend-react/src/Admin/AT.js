...
const AT = () => {
    ...
    try {
      const fetchData = async (tokenToUse = accessToken, retryCount = 0) => {
        try {
          const res = await fetch('http://localhost:5000/admin/add-theaters', {
            method: 'POST',
            headers: { 
                ...
                <div className="admin-screens-section">
                  ...
                  <Accordion activeKey={activeScreen} onSelect={setActiveScreen}>
                    {Array.from({ length: formData.numberOfScreens }).map((_, index) => (
                      <Card key={index} className="admin-screen-card">
                              ...
                              <Col md={6}>
                                <Form.Group className="admin-theaters-form-group">
                                  ...
                                  <Form.Control
                                    type="number"
                                    name="elite_seats"
                                    value={formData.screens[index]?.elite_seats || 0}
                                    onChange={(e) => handleScreenChange(index, e)}
                                    min="0"
                                    className="admin-theaters-input"
                                  />
                              ...
                              <Col md={6}>
                                <Form.Group className="admin-theaters-form-group">
                                  ...
                                  <Form.Control
                                    type="number"
                                    name="elite_price"
                                    value={formData.screens[index]?.elite_price || 0}
                                    onChange={(e) => handleScreenChange(index, e)}
                                    min="0"
                                    step="0.01"
                                    className="admin-theaters-input"
                              ...
                              <Col md={6}>
                                <Form.Group className="admin-theaters-form-group">
                                  ...
                                  <Form.Control
                                    type="number"
                                    name="premium_seats"
                                    value={formData.screens[index]?.premium_seats || 0}
                                    onChange={(e) => handleScreenChange(index, e)}
                                    min="0"
                                    className="admin-theaters-input"
                                  />
                              ...
                              <Col md={6}>
                                <Form.Group className="admin-theaters-form-group">
                                  ...
                                  <Form.Control
                                    type="number"
                                    name="premium_price"
                                    value={formData.screens[index]?.premium_price || 0}
                                    onChange={(e) => handleScreenChange(index, e)}
                                    min="0"
                                    step="0.01"
                                    className="admin-theaters-input"
